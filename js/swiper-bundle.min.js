                ...
                if (
                    ...
                    if (
                        !(
                            ...
                            Math.sqrt(Math.pow(u, 2) + Math.pow(c, 2)) < this.params.threshold
                        )
                    )
                        if (
                            (void 0 === i.isScrolling &&
                                ...
                                (this.isVertical() && a.currentX === a.startX)
                                    ? (i.isScrolling = !1)
                                    : u * u + c * c >= 25 &&
                                      ((p = (180 * Math.atan2(Math.abs(c), Math.abs(u))) / Math.PI),
        ...
        V = {
            ...
            eventsEmitter: {
                ...
                onAny: function (e, t) {
                    ...
                    return (
                        this.eventsAnyListeners.indexOf(e) < 0 && this.eventsAnyListeners[i](e),
                        this
                    );
                },
                offAny: function (e) {
            ...
            translate: {
                ...
                translateTo: function (e, t, i, s, a) {
                    ...
                    var o,
                        ...
                        h = r.maxTranslate();
                    if (
                        ((o = s && e > d ? d : s && e < h ? h : e), r.updateProgress(o), n.cssMode)
                    ) {
                        var p,
                            u = r.isHorizontal();
                        return (
    ...
    var W = {
            update: function (e) {
                ...
                for (var P = 0; P < u.length; P += 1)
                    P >= b &&
                        P <= E &&
                        (void 0 === p || e ? M.push(P) : (P > p && M.push(P), P < h && C.push(P)));
        ...
        q = {
            ...
            create: function () {
                M(this, {
                    virtual: t(t({}, W), {}, { slides: this.params.virtual.slides, cache: {} }),
                });
            },
            on: {
        ...
        j = {
            ...
            enable: function () {
                ...
                this.keyboard.enabled ||
                    (m(e).on('keydown', this.keyboard.handle), (this.keyboard.enabled = !0));
            },
            disable: function () {
                var e = r();
                this.keyboard.enabled &&
                    (m(e).off('keydown', this.keyboard.handle), (this.keyboard.enabled = !1));
            },
        },
        _ = {
            name: 'keyboard',
                    ...
                    if (!h) {
                        ...
                        if (
                            ...
                            var f = v.length ? v[v.length - 1] : void 0,
                                g = v[0];
                            if (
                                (v.push(o), f && (o.delta > f.delta || o.direction !== f.direction))
                            )
                                v.splice(0);
                            else if (
                                v.length >= 15 &&
                    ...
                    if (
                        ...
                        if (
                            (t.dynamicBullets &&
                                ...
                                (o =
                                    ((l = n + (Math.min(d.length, t.dynamicMainBullets) - 1)) + n) /
                                    2)),
                            d.removeClass(
                                t.bulletActiveClass +
                                    ' ' +
        ...
        J = {
            ...
            init: function () {
                if (this.params.scrollbar.el) {
                    ...
                    0 === a.length &&
                        ((a = m('<div class="' + this.params.scrollbar.dragClass + '"></div>')),
                        s.append(a)),
            ...
            onGestureChange: function (e) {
                ...
                a.$imageEl && 0 !== a.$imageEl.length
                    ? (t.gestures
                      ...
                      s.scale > a.maxRatio &&
                          (s.scale = a.maxRatio - 1 + Math.pow(s.scale - a.maxRatio + 1, 0.5)),
                      s.scale < i.minRatio &&
                ...
                if (e.enabled) {
                    ...
                    t.gestures
                        ...
                        : 'touchstart' === this.touchEvents.start &&
                          ...
                          this.touchEvents.cancel &&
                              this.$wrapperEl.off(this.touchEvents.cancel, a, e.onGestureEnd, i)),
                        this.$wrapperEl.off(
                            this.touchEvents.move,
                            '.' + this.params.zoom.containerClass,
                            e.onTouchMove,
            ...
            init: function () {
                ...
                e.a11y.addElId(n, l),
                    ...
                    a &&
                        ...
                        'BUTTON' !== a[0].tagName &&
                            (e.a11y.addElRole(a, 'button'), a.on('keydown', e.a11y.onEnterKey)),
            ...
            setTranslate: function () {
                ...
                for (var c = 0; c < s.length; c += 1) {
                    ...
                    var T =
                        ...
                        'px)';
                    if (
                        (y <= 1 && y > -1 && ((u = 90 * f + 90 * y), n && (u = 90 * -f - 90 * y)),
                        v.transform(T),
                        d.slideShadows)
                    ) {
                        var C = h
            ...
            onThumbClick: function () {
                ...
                if (e) {
                    ...
                    if (
                        ...
                        if (
                            ((s = e.params.loop
                                ? parseInt(m(e.clickedSlide).attr('data-swiper-slide-index'), 10)
                                : t),
                            this.params.loop)
                        ) {
                            var a = this.activeIndex;
